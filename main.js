/*
 * For transfer Token
 * https://github.com/ethers-io/ethers.js/issues/121
 * */
...
const run = async () => {
  ...
  // const mnemonic =
  ("fashion bulk ecology zebra behind polar actual shuffle blue multiply utility absurd");
  ...
  const sender = ethers.Wallet.fromPhrase(
    "fee bag nurse zoo load yellow music used nature recycle spike edit",
    provider
  );
  ...
  const numberOfTokens = ethers.parseUnits("0.1");
